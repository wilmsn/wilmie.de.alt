...
<p>Diese Webseite l&auml;uft auf einem Raspberry PI<br>und wurde f&uuml;r den Firefox Browser optimiert.</p>
</td></tr></table>
</center>
<?php
if($mobile_browser) { 
  echo "</small></small><br><hr><div><img src=/img/kontakt.png></div>\n";
}
